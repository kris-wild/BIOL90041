...
R calculator: What is 5 times 6?
...
<div class = "prompt"> R calculator: What is 138 squared?</div>
...
Define two variables, `apple_price` (0.75) and `orange_price` (0.65), then define `num_apples` (10) and `num_oranges` (8). Compute the **total cost** using only these variables (combine and multiply accordingly).
