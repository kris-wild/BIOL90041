...
ou should already be working inside your R Project for this workshop. This means R will treat your project folder as the starting point for any file paths, so you only need to tell it where your .csv file is stored within that folder. If your data are saved inside a data folder in your project, your file path will begin with `data/`. 
...
## Step 4: Start your cleaning protocol!
